...
[numthreads(1, 1, 1)]
void cs_particles_soja_explosion_spawn( 
...
)
{
  ...
  float3 localPos = input.Pos.xyz * (float3(0.1f,0.1f,0.1f) + abs(normalize(instance.dir)));
  float3 p = instance.pos + (localPos * instance.scale * 1.5f);
