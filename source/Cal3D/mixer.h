...
public:
  ...
  CalVector getAndClearDeltaRootMotion() {
    CalVector new_delta = delta_root_pos;
...
protected:
  ...
  bool          prev_local_info_is_valid = false;
  CalVector     prev_local_root_pos;

  CalVector     delta_root_pos;
